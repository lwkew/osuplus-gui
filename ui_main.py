...
################################################################################
## Form generated from reading UI file 'GUI_BASEHkHlIL.ui'
##
...
"}")
        ...
        self.label_user_icon.setMaximumSize(QSize(59, 60))
        font4 = QFont()
        font4.setFamily(u"Aller")
...
"}")
        ...
        self.layout_menu_bottom.addWidget(self.label_user_icon, 0, Qt.AlignHCenter|Qt.AlignTop)
        ...
        self.title = QLabel(self.page_home)
        self.title.setObjectName(u"title")
        self.title.setMaximumSize(QSize(16777215, 16777215))
        font5 = QFont()
        font5.setFamily(u"Aller")
        ...
        self.maintext = QLabel(self.page_home)
        self.maintext.setObjectName(u"maintext")
        self.maintext.setEnabled(True)
        self.maintext.setMaximumSize(QSize(16777215, 200))
        font6 = QFont()
        font6.setFamily(u"Aller")
        font6.setPointSize(14)
        font6.setBold(True)
        font6.setWeight(75)
        self.maintext.setFont(font6)
        self.maintext.setAlignment(Qt.AlignCenter)

        self.verticalLayout_10.addWidget(self.maintext)
        ...
        sizePolicy5.setHeightForWidth(self.btn_go.sizePolicy().hasHeightForWidth())
        self.btn_go.setSizePolicy(sizePolicy5)
        self.btn_go.setMaximumSize(QSize(300, 40))
        self.btn_go.setFont(font6)
        self.btn_go.setMouseTracking(False)
        self.btn_go.setStyleSheet(u"QPushButton {\n"
"	background-color: rgb(62, 67, 80);\n"
"}\n"
"QPushButton:hover {\n"
"	background-color: rgb(72, 77, 88);\n"
"}\n"
"QPushButton:pressed {	\n"
"	background-color: rgb(85, 170, 255);\n"
"}")
        ...
        self.page_extra = QWidget()
        self.page_extra.setObjectName(u"page_extra")
        self.verticalLayoutWidget = QWidget(self.page_extra)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(0, 0, 901, 601))
        self.verticalLayout_12 = QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_12.setObjectName(u"verticalLayout_12")
        self.verticalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.title_2 = QLabel(self.verticalLayoutWidget)
...
"}")
        ...
        self.verticalLayoutWidget_2 = QWidget(self.page_widgets)
        self.verticalLayoutWidget_2.setObjectName(u"verticalLayoutWidget_2")
        self.verticalLayoutWidget_2.setGeometry(QRect(-10, 220, 911, 131))
        self.verticalLayout_7 = QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.verticalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.HardRock = QCheckBox(self.verticalLayoutWidget_2)
        self.HardRock.setObjectName(u"HardRock")
        sizePolicy6 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.HardRock.sizePolicy().hasHeightForWidth())
        self.HardRock.setSizePolicy(sizePolicy6)
        self.HardRock.setMaximumSize(QSize(16777215, 25))
        self.HardRock.setFont(font7)
        self.HardRock.setAutoFillBackground(False)
        self.HardRock.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.HardRock, 0, Qt.AlignHCenter)

        self.DoubleTime = QCheckBox(self.verticalLayoutWidget_2)
        self.DoubleTime.setObjectName(u"DoubleTime")
        sizePolicy6.setHeightForWidth(self.DoubleTime.sizePolicy().hasHeightForWidth())
        self.DoubleTime.setSizePolicy(sizePolicy6)
        self.DoubleTime.setMaximumSize(QSize(16777215, 25))
        self.DoubleTime.setFont(font7)
        self.DoubleTime.setAutoFillBackground(False)
        self.DoubleTime.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.DoubleTime, 0, Qt.AlignHCenter)

        self.Hidden = QCheckBox(self.verticalLayoutWidget_2)
        self.Hidden.setObjectName(u"Hidden")
        self.Hidden.setMaximumSize(QSize(16777215, 26))
        self.Hidden.setFont(font7)
        self.Hidden.setAutoFillBackground(False)
        self.Hidden.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.Hidden, 0, Qt.AlignHCenter)

        self.Flashlight = QCheckBox(self.verticalLayoutWidget_2)
        self.Flashlight.setObjectName(u"Flashlight")
        sizePolicy6.setHeightForWidth(self.Flashlight.sizePolicy().hasHeightForWidth())
        self.Flashlight.setSizePolicy(sizePolicy6)
        self.Flashlight.setMaximumSize(QSize(16777215, 25))
        self.Flashlight.setFont(font7)
        self.Flashlight.setAutoFillBackground(False)
        self.Flashlight.setStyleSheet(u"")

        self.verticalLayout_7.addWidget(self.Flashlight, 0, Qt.AlignHCenter)

        self.title_3 = QLabel(self.page_widgets)
        self.title_3.setObjectName(u"title_3")
        self.title_3.setGeometry(QRect(10, 140, 882, 81))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.maintext.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>osu!plus is an program that allows you to see your latest scores</p><p>and enables easy comparison</p><p>It also has a recommendation feature that uses your personal scores </p><p>to calculate the best recommendation</p><p>to begin, input your username + click the 'Get Scores' button below</p></body></html>", None))
